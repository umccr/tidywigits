...
configuration files that are part of child nemo packages like {tidywigits} and
{dracarys}.
...
Let's look at some of the information for the raw PURPLE config (from {tidywigits}),
for instance:
...
ppl <- tidywigits::Purple$new(path = ppl_path)
...
ppl2 <- tidywigits::Purple$new(path = ppl_path)
ppl2$files
